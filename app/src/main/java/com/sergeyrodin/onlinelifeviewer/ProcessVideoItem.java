...
public class ProcessVideoItem {
    ...
    public static void process(FragmentActivity activity, VideoItem psItem) {
        if (psItem != null) {
    ...
    static class SizeAsyncTask extends AsyncTask<VideoItem, Void, VideoItem> {
        ...
        @Override
        protected VideoItem doInBackground(VideoItem... items) {
            VideoItem psItem = items[0];
            try {
        ...
        @Override
        protected void onPostExecute(VideoItem psItem) {
